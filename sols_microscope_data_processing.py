...
scan_step_size_px, preview_line_px, timestamp_mode = 3, 10, "binary+ASCII"
...
print('\nGetting: roi', end=' ')
roi = dataroi.get(data, ts, signal_to_bg_ratio=1.2, gaussian_filter_std=3)
...
roi_preview = datapreview.get(roi, s_px, l_px, ts)
...
native = datanative.get(roi, s_px)
...
traditional = datatraditional.get(native_subset, s_px)
